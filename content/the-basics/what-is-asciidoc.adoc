...
aliases: ["/what-is-asciidoc", "/what-is-asciidoc-why-use-it"]
weight: 120
---
...
With an understanding of what AsciiDoc is and why it's so desperately needed, you're encouraged to delve into the AsciiDoc syntax covered in the {docref}/asciidoc-writers-guide[AsciiDoc Writer's Guide].
If you're just looking for a cheat sheet, check out the {docref}/asciidoc-syntax-quick-reference[AsciiDoc Quick Reference].
