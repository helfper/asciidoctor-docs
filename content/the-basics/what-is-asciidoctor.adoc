---
title: "What is Asciidoctor?"
aliases: ["/what-is-asciidoctor"]
weight: 110
---
...
While Asciidoctor aims to offer full compliance with the AsciiDoc syntax implemented by AsciiDoc Python ({docref}/asciidoc-asciidoctor-diffs[with some exceptions]), it's far more than just a clone of AsciiDoc Python.
