...
aliases: ["/asciidoc-writers-guide"]
weight: 320
---
...
:uri-install: {docref}/install-toolchain/
:fopub-doc-ref: https://github.com/asciidoctor/asciidoctor-fopub/blob/master/README.adoc
:user-ref: {docref}/user-manual
:docs-ref: {docref}
:uri-editing: {docref}/editing-asciidoc-with-live-preview/
:gist-ref: https://gist.github.com
:publican-ref: https://fedorahosted.org/publican
:uri-quick: {docref}/asciidoc-syntax-quick-reference/
:uri-what-asciidoc: {docref}/what-is-asciidoc-why-use-it
