...
include::../the-basics/asciidoc-vs-markdown.adoc[leveloffset=+2]
...
For details see {docref}/asciidoctorj[Getting Started with Asciidoctor in Java using AsciidoctorJ].
...
For details see {docref}/asciidoctor-gradle-plugin/[Getting Started with the Asciidoctor Gradle Plugin].
...
For details see {docref}/asciidoctor-maven-plugin[Installing and Using the Asciidoctor Maven Plugin].
...
For details see {docref}/install-and-use-asciidoctorjs[Installing and Using Asciidoctor.js].
...
See {docref}/asciidoc-syntax-quick-reference/#markdown-compatibility[Markdown Compatibility] to learn what syntax is shared.
...
See {docref}/migrating-from-msword[Migrating to AsciiDoc from MS Word].
