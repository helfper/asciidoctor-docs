---
title: "Migrating to Asciidoctor 1.5.0"
aliases: ["/migration"]
weight: 920
---
...
If you want to continue to use the old icon names, you can incorporate the https://raw.githubusercontent.com/asciidoctor/asciidoctor/master/compat/font-awesome-3-compat.css[font-awesome-3-compat.css] file from the Asciidoctor repository into your generated HTML using a {docref}/user-manual/#docinfo-file[docinfo file].
